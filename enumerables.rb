...
def sort_by_heat(spicy_foods)
  # your code here
  #spice_rank=spicy_foods.map do |food|
   # spicy_foods[:heat_level].sort
  #end
  #spice_rank.reverse
...
def print_spiciest_foods(spicy_foods)
  ...
  output_spicy_foods(filtered_foods)
end
...
def average_heat_level(spicy_foods)
  # your code here
  average_heat_level=spicy_foods.map do |food|
    spicy_foods[:heat_level].sum / spicy_foods[:heat_level].length
  end
end
